module github.com/crate/cratedb-grafana-datasource
...
// go.sum is intentionally absent in this skeleton; run `go mod tidy` as the
// first real-build step (see docs/architecture.md, spike plan).
