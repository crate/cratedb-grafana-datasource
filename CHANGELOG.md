...
- **Tooling**: built on the `@grafana/create-plugin` 7.9.0 scaffold. Go sources are linted with
  golangci-lint, dependency install scripts are disabled by default (supply-chain hardening), and
  frontend bundle size is reported on pull requests.
